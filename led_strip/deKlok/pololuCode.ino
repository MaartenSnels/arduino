/*
  ...
  Bewerkte code uit de examples van de PololuLedStrip drivers, zie include directory
...
void colorExplosion(int loopCount, unsigned char noNewBursts)
{
...
// still in progress).
unsigned char collision(int loopCount)
{
...
void traditionalColors(int loopCount)
{
