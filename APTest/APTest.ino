...
const char* ssid = "svdh3";
const char* password = "12345678901234567890123456";
const char* host = "deKlokHost";
...
void handleNotFound(){
  ...
  String message = "SDCARD Not Detected<p><p>";
  message += "URI: ";
  message += server.uri();
  message += "<p>Method: ";
  ...
  for (uint8_t i=0; i<server.args(); i++){
    message += " NAME:"+server.argName(i) + " VALUE:" + server.arg(i) + "<p>";
  }
  message+="<form>ssid:<input type='text' name='ssid'/>";
  message+="<p>pwd:<input type='text' name='ssid'/>";
  message+="<p>pwd:<input type='submit' value='ok'/></form>";
